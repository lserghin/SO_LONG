...
/*   Updated: 2025/03/14 16:38:58 by lserghin         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	*(*(directions + 0) + 0) = "textures/p/p_u_1.xpm";
	*(*(directions + 0) + 1) = "textures/p/p_u_2.xpm";
	*(*(directions + 0) + 2) = "textures/p/p_u_3.xpm";
	*(*(directions + 0) + 3) = "textures/p/p_u_4.xpm";
	*(*(directions + 1) + 0) = "textures/p/p_d_1.xpm";
	*(*(directions + 1) + 1) = "textures/p/p_d_2.xpm";
	*(*(directions + 1) + 2) = "textures/p/p_d_3.xpm";
	*(*(directions + 1) + 3) = "textures/p/p_d_4.xpm";
	*(*(directions + 2) + 0) = "textures/p/p_l_1.xpm";
	*(*(directions + 2) + 1) = "textures/p/p_l_2.xpm";
	*(*(directions + 2) + 2) = "textures/p/p_l_3.xpm";
	*(*(directions + 2) + 3) = "textures/p/p_l_4.xpm";
	*(*(directions + 3) + 0) = "textures/p/p_r_1.xpm";
	*(*(directions + 3) + 1) = "textures/p/p_r_2.xpm";
	*(*(directions + 3) + 2) = "textures/p/p_r_3.xpm";
	*(*(directions + 3) + 3) = "textures/p/p_r_4.xpm";
	return ;
}
...
void	ft_load_asset_collectables(t_game *game)
{
	*(game->collectable_img + 0) = mlx_xpm_file_to_image(game->mlx,
			"textures/c/c_1.xpm", &(int){TILE_SIZE}, &(int){TILE_SIZE});
	*(game->collectable_img + 1) = mlx_xpm_file_to_image(game->mlx,
			"textures/c/c_2.xpm", &(int){TILE_SIZE}, &(int){TILE_SIZE});
	*(game->collectable_img + 2) = mlx_xpm_file_to_image(game->mlx,
			"textures/c/c_3.xpm", &(int){TILE_SIZE}, &(int){TILE_SIZE});
	*(game->collectable_img + 3) = mlx_xpm_file_to_image(game->mlx,
			"textures/c/c_4.xpm", &(int){TILE_SIZE}, &(int){TILE_SIZE});
...
void	ft_load_assets(t_game *game)
{
	...
	if (!game->exitc_img)
		ft_exitwitherror(game, "FAILED TO LOAD EXIT TEXTURE!\n");
	game->enemy_img = mlx_xpm_file_to_image(game->mlx, "textures/m/m_d.xpm",
			&(int){TILE_SIZE}, &(int){TILE_SIZE});
	if (!game->enemy_img)
